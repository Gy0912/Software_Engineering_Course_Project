...
class TestVendingMachineUI(unittest.TestCase):
    ...
    def test_login_admin_success(self):
        ...
        self.assertFalse(self.ui.pwd_entry.isEnabled())
        self.assertFalse(self.ui.login_btn.isEnabled())
    ...
    def test_logout_admin(self):
        ...
        self.assertFalse(self.ui.state)
        self.assertFalse(self.ui.admin_panel.isVisible())
        self.assertTrue(self.ui.pwd_entry.isEnabled())
        self.assertTrue(self.ui.login_btn.isEnabled())
